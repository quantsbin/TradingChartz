...
triple_barrier = TripleBarrierSetter(2, 10, 'preceding_low_adj', .02, .1)
buffer_value= 0
...
candle_tb_details.to_csv('TB_Analysis_detailed_with_2_10_sl_10v.csv')

# tb_summary_df.to_csv(r"tb_summary_with_test1.csv")
